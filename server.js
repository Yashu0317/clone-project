...
async function testDatabase() {
    ...
    try {
        ...
        console.log("MySQL connected and recordings table is ready.");

    } catch (err) {

        console.error("");
        console.error("====================================");
        console.error("MYSQL CONNECTION/TABLE ERROR");
        console.error("====================================");
...
app.get("/", (_req, res) => {
    ...
    res.sendFile(
        path.join(__dirname, "comms-hub-5.html")
    );
    ...
    async (req, res) => {
        ...
        try {
            ...
            if (!fs.existsSync(filePath)) {
                ...
                return res
                    .status(404)
                    .send("Recording file is missing.");
